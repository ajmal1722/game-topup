...
export default function OrderDetailsPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    if (!order) {
        return (
            <div className="min-h-screen bg-primary pt-24 pb-16 px-4 text-center">
                <RiInformationLine className="text-gray-500 text-5xl mx-auto mb-4" />
                <h1 className="text-2xl font-bold text-white mb-4">Order Not Found</h1>
                <Link href="/orders" className="text-secondary hover:underline flex items-center justify-center gap-2">
                        ...
                        <div className="bg-white/5 border border-white/10 p-6 rounded-2xl">
                            ...
                            <div className="grid sm:grid-cols-2 gap-6">
                                {order.userInputs.map((input) => (
                                    <div key={input.key} className="bg-white/5 p-4 rounded-xl border border-white/5">
